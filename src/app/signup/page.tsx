      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-none shadow-2xl rounded-[2.5rem] overflow-hidden bg-card/80 backdrop-blur-xl">
          <CardHeader className="space-y-1 text-center pt-10">
            <CardTitle className="text-3xl font-black font-heading">{t.auth.signupTitle}</CardTitle>
          ...
          <CardContent className="grid gap-6 p-8">
            ...
            <form onSubmit={handleSignup} className="grid gap-6">
              <div className="grid gap-3">
                <Label htmlFor="name" className="text-xs font-black uppercase tracking-widest text-muted-foreground ml-1">{t.common.fullName}</Label>
                <Input id="name" placeholder="John Doe" value={name} onChange={(e) => setName(e.target.value)} required className="h-14 rounded-2xl bg-secondary/50 border-none px-6 font-bold" />
              </div>
              <div className="grid gap-3">
              ...
              <div className="grid gap-3">
                <Label htmlFor="password" title={t.common.password} className="text-xs font-black uppercase tracking-widest text-muted-foreground ml-1">{t.common.password}</Label>
